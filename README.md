...
No Terminal/Console:
<ol>
	<li>Faça um clone do projeto na sua máquina: <code>git clone https://github.com/thekauej/ifood-dev-week.git</code></li>
	<li>Entre na pasta raiz do projeto: <code>cd ifood-dev-week</code></li> 
